...
abstract class MyCentralManagerFlutterAPI {
  ...
  void onDiscovered(MyPeripheralArgs peripheralArgs, int rssiArgs, int timestampArgs, MyAdvertisementTypeArgs typeArgs, MyAdvertisementArgs advertisementArgs, MyAddressTypeArgs addressTypeArgs);
    ...
    }
    {
      ...
      if (api == null) {
        ...
        __pigeon_channel.setMessageHandler((Object? message) async {
          ...
          final MyAddressTypeArgs? arg_addressTypeArgs = args[5] == null ? null : MyAddressTypeArgs.values[args[5]! as int];
          assert(arg_addressTypeArgs != null,
              'Argument for dev.flutter.pigeon.bluetooth_low_energy_windows.MyCentralManagerFlutterAPI.onDiscovered was null, expected non-null MyAddressTypeArgs.');
          try {
            api.onDiscovered(arg_peripheralArgs!, arg_rssiArgs!, arg_timestampArgs!, arg_typeArgs!, arg_advertisementArgs!, arg_addressTypeArgs!);
            return wrapResponse(empty: true);
          } on PlatformException catch (e) {
            return wrapResponse(error: e);
          }          catch (e) {
